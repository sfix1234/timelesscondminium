  ...
  <div className="artisan-detail" id="artisanDetail">
    ...
    <div className="artisan-detail__sheet">
      ...
      <article className="artisan-detail__content" data-artisan-detail="9">
        ...
        <p className="artisan-detail__text">
          和泉守兼定とは、19世紀後半の幕末を代表する刀工の名であり、同氏が手がけた刀の名称でもある。新選組副長・土方歳三が生涯の愛刀として帯び続けたことで、その名は歴史に深く刻まれた。<br />
          十一代 和泉守兼定は、天保8年（1837年）、会津若松に生まれる。十代兼定の子として幼少より刀の世界に育ち、16歳で父の代作銘を担うほどの才を示した。文久3年（1863年）、藩命を受けて上京し「和泉守兼定」と改銘。以来、幕末から明治にかけて、激動の時代を刀工として生き抜いた。明治25年（1892年）には皇太子（後の大正天皇）へ刀を献上。その技は時代を超えて認められ続けた。<br />
          作風は実剛にして機能的。身幅は尋常、重ねは厚く、手にすれば優れたバランスを感じさせる。華美な装飾を一切排し、ただ武器としての完成を追い求めた造り。後世、その切れ味は「最上大業物（さいじょうおおわざもの）」と評された。<br />
          そしてその刃を、生涯手放さなかった男がいる。新撰組副長・土方歳三。池田屋事件、禁門の変、鳥羽伏見の戦い。幕末の激動を、この刀は使い手とともに駆け抜けた。明治2年（1869年）5月、土方は箱館五稜郭にて戦死した。享年35歳。しかし刀は今もここに在る。激動の時代を生き、最後まで己の道を貫いた男。その意志ごと、刃の内に封じた比類なき名刀。
        </p>
      </article>
    </div>
  </div>

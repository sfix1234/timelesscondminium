...
import PropertyFloorMapOnly from './components/property-floor-map-only';
import PropertyFloorImagePanel from './components/property-floor-image-panel';
...
export async function HomePageContent({ forceUnlocked = false } = {}) {
      ...
      <div className="hero-story-scene__logo-sticky">
        <div className="floating-logo">
          ...
          <div className="floating-logo__main">
            <img src="/assets/images/thesilence_logo_white.png" alt="" className="floating-logo__image" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="stage__inner">
      ...
      <div className="stage__row">
        ...
        <nav className="stage__tabs">
          ...
          <button className="stage__tab" type="button" data-tab="2" data-ja="上七軒-旧長谷川邸" data-en="Kamishichiken" data-zh-hans="关于上七轩" data-zh-hant="關於上七軒">上七軒-旧長谷川邸</button>
        ...
        <div className="stage__info">
          <div className="stage__info-block is-active" data-info="0">
            ...
            <div className="stage__info-body">
              <p className="stage__info-text" data-ja={'千年の都・京都は、宮廷文化、宗教、茶道、庭園、建築、芸能、和食など\n日本文化の根幹を育み、世界へ継承し続ける稀有な都市。'} data-en="Kyoto, the ancient capital of a thousand years, has cultivated the essence of Japanese culture, from courtly traditions and spirituality to tea ceremony, gardens, architecture, performing arts, and cuisine, continuing to share its legacy with the world as a city unlike any other." data-zh-hans="千年古都京都，孕育了宫廷文化、宗教信仰、茶道、庭园、建筑、艺能与和食等日本文化之根脉，并恒久流转于世界，独成其境。" data-zh-hant="千年古都京都，孕育宮廷文化、宗教信仰、茶道、庭園、建築、藝能與和食等日本文化之根脈，並恆久流轉於世界，獨成其境。">千年の都・京都は、宮廷文化、宗教、茶道、庭園、建築、芸能、和食など<br />日本文化の根幹を育み、世界へ継承し続ける稀有な都市。</p>
          ...
          <div className="stage__info-block" data-info="2">
            ...
            <div className="stage__info-body">
              <p className="stage__info-text" data-ja={'北野天満宮の再建余材から生まれた上七軒は、世界最古級のサステナブル精神を宿す\n日本最古の花街。旧長谷川邸はその象徴。'} data-zh-hans="由北野天满宫重建剩余木材孕育而生的上七轩（Kamishichiken），承载世界最古老可持续发展精神，为日本最古之花街（Hanamachi，历史艺伎街区）。旧长谷川邸（Former Hasegawa Residence），正是这一精神的象征。" data-zh-hant="由北野天滿宮重建餘材所生的上七軒，承載世界最古層級的可持續精神，為日本最古之花街。舊長谷川邸，為其象徵。" data-en={"Emerging from the salvaged timbers of Kitano Tenmangu\u2019s reconstruction, Kamishichiken is Japan\u2019s oldest hanamachi (geisha district) imbued with a spirit of sustainability ahead of its time. The former Hasegawa Residence remains in its timeless emblem."}>北野天満宮の再建余材から生まれた上七軒は、世界最古級のサステナブル精神を宿す<br />日本最古の花街。旧長谷川邸はその象徴。</p>
              <button className="stage__more-link" type="button">VIEW MORE<span className="stage__more-arrow">→</span></button>
            </div>
          </div>
  ...
  <div className="detail-panel" id="detailPanel">
    ...
    <div className="detail-panel__body">
      ...
      <div className="detail-panel__content" data-detail="1">
        ...
        <div className="detail-panel__text">
          <h4 className="detail-panel__lead" data-ja={'芸能文化が息づく\n特別な聖地'} data-en="A sacred realm where the legacy of the performing arts endures." data-zh-hans="艺能流转之地，静谧而深远" data-zh-hant="藝能流轉之地，靜謐而深遠">芸能文化が息づく<br />特別な聖地</h4>
      ...
      <div className="detail-panel__content" data-detail="3">
        ...
        <div className="detail-panel__text">
          <h4 className="detail-panel__lead" data-ja={'偉人たちが愛した\n上七軒・旧 長谷川邸'} data-en={"The Former Hasegawa Residence, A Legacy Admired by History\u2019s Greats."} data-zh-hans="为名士所钟爱的上七轩・旧长谷川邸" data-zh-hant="為名士所鍾愛的上七軒・舊長谷川邸">偉人たちが愛した<br />上七軒・旧 長谷川邸</h4>
  ...
  {/* Registration gate — everything from the Floor map onward requires access */}
  <AccessGate initialUnlocked={isUnlocked} isClientPreview={isClientPreview}>
  <>
  {/* Floor map + Floor image — two static clone sections sharing one
      .property-page wrapper (the /property base #id rules cascade onto
      these clones, so the ids are intentionally kept). */}
  <div className="property-page">
    {/* Floor map */}
    <section id="property-kuma" className="property-floor-clone">
      <div id="property-info" className="property-info property-info--clone-scope">
        <section className="property-info__clone-block property-info__clone-block--map" aria-label="Floor Map">
          <div className="property-info__inner">
            <div className="property-info__details">
              <PropertyFloorMapOnly />
            </div>
          </div>
        </section>
      </div>
    ...
    <section id="property-kuma" className="property-floor-clone">
      <div id="property-info" className="property-info property-info--clone-scope">
        <section className="property-info__clone-block property-info__clone-block--image" aria-label="Floor Image">
          <div className="property-info__inner">
            <div className="property-info__details">
  ...
  {/* Project Overview — placed directly below ACCESS */}
  <div className="property-page">
  ...
  {/* Executive Producer — placed directly below Project Overview */}
  <div className="property-page">
  ...
  {/* Giorgio Armani homage — placed directly below Executive Producer */}
  <div className="property-page">
  ...
  {/* CONTACT — placed below the Armani homage */}
  <div className="property-page">
    <section id="property-contact" className="property-contact-block">
      <div className="property-contact-block__inner">
        <div className="property-contact-block__intro">
          ...
          <p className="property-contact-block__lead" data-ja={"本物件は、上七軒の伝統と文化を継承いただける方をお迎えするため、販売に際し、事前面談等による審査制を採用しております。　THE SILENCE - Furnished by ARMANI / CASA に関するお問い合わせは、WhatsAppまたは下記フォームより承っております。担当者より折り返しご案内申し上げます。"} data-zh-hans="本项目为传承上七轩之传统与文化，仅面向具备相应理念的客户开放，销售过程中采用审核制，并设有事前面谈等流程。　关于 THE SILENCE - Furnished by ARMANI / CASA 的相关咨询，欢迎通过 WhatsApp 或下方表单与我们联系，专属顾问将为您提供后续说明与服务。" data-zh-hant="本物件為承襲上七軒之傳統與文化，僅迎接具備相應理念之人士，於銷售過程中採審查制度，並設有事前面談等流程。　有關 THE SILENCE - Furnished by ARMANI / CASA 之相關諮詢，歡迎透過 WhatsApp 或下方表單與我們聯繫，專人將為您提供後續說明與服務。" data-en={"To ensure that the traditions and culture of Kamishichiken are preserved, this property is offered for sale under a screening process, including a prior interview with prospective buyers.　For inquiries regarding “THE SILENCE – Furnished by ARMANI / CASA,” please contact us via WhatsApp or through the form below. A representative will get back to you shortly."}>
            本物件は、上七軒の伝統と文化を継承いただける方をお迎えするため、<br />
            販売に際し、事前面談等による審査制を採用しております。<br />
            <br />
            THE SILENCE - Furnished by ARMANI / CASA に関するお問い合わせは、<br />
            WhatsAppまたは下記フォームより承っております。<br />
            担当者より折り返しご案内申し上げます。
          </p>
  ...
  <div className="artisan-detail" id="artisanDetail">
    ...
    <div className="artisan-detail__sheet">
      ...
      <article className="artisan-detail__content" data-artisan-detail="5">
        <div className="artisan-detail__portrait artisan-detail__portrait--video">
          <iframe
            className="artisan-detail__portrait-embed"
            src="about:blank"
            data-src="https://player.vimeo.com/video/1181434749?title=0&byline=0&portrait=0&badge=0&autopause=0&player_id=0&app_id=58479"
            frameBorder="0"
            allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share"
            referrerPolicy="strict-origin-when-cross-origin"
        ...
        <div className="artisan-detail__meta">
          ...
          <p className="artisan-detail__en">KOUKEI ERI</p>
        </div>
        ...
        <ArtisanProfessionalsGallery artisanId="5" artisanName="KOUKEI ERI" />
      </article>
      ...
      <article className="artisan-detail__content" data-artisan-detail="9">
        ...
        <p className="artisan-detail__text artisan-detail__text--coming-soon" data-ja="詳細は近日公開予定です。Coming soon..." data-en="Details coming soon..." data-zh-hans="详细内容即将公开，敬请期待..." data-zh-hant="詳細內容即將公開，敬請期待...">
          詳細は近日公開予定です。Coming soon...
        </p>
      </article>
    </div>
  </div>

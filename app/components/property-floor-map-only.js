...
// Map-only variant of PropertyFloorMapSwitcher, used on the home page (/)
// so the floor map and the floor image can live in two independent sections.
// The shared PropertyFloorMapSwitcher (used by /property) is left untouched.
export default function PropertyFloorMapOnly() {
